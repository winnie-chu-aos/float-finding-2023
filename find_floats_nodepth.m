function [PlotMapErr,PlotCoverage,float_locations,Irange,Jrange]=find_floats_nodepth(num_iter)
...
cd /data/SO6/TPOSE/bgc_tpose6/2004_fwd_run_SAVE/diags/ %new model
